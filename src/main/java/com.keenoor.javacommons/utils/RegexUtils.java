...
import com.keenoor.javacommons.utils.constant.RegexConstants;
...
public final class RegexUtils {
    ...
    public static boolean isPositiveFloat(final CharSequence input) {
        return input != null
                && (isMatch(RegexConstants.REGEX_POSITIVE_INTEGER, input)
                || isMatch(RegexConstants.REGEX_POSITIVE_FLOAT, input));
    }
}
